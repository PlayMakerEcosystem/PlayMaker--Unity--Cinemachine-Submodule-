...
namespace HutongGames.PlayMaker.Actions.ecosystem.cinemachine
{
    ...
    public class VirtualCameraSetFramingTransposerSettings : CinemachineActionSetFramingTransposerSettingsBase<CinemachineVirtualCamera>
    {
        [RequiredField]
        ...
        void Execute()
        {
            ...
            this.SetFramingTransposerSettings(ref CachedCinemachineComponent);
        }
    }
}